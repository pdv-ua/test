...
function checkDate (ctx, instanceData) {
  ...
  const payElTimeCostStore = UB.DataStore('hr_payElTimeCost')
  ...
  const payElTimeCost = UB.Repository('hr_payElTimeCost')
    ...
    .where('dictTimeCostID', '=', execParams.dictTimeCostID || instanceData.dictTimeCostID)
