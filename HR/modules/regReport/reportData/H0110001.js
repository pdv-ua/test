...
function prepareDataSpecific ({ data, params }) {
  ...
  organiozations.forEach(orgID => {
    ...
    DECLARBODY.B0101 = accrualService.round((DECLARBODY.B0101 || 0) + B0101 / 12, 0)
    DECLARBODY.B0103 = accrualService.round((DECLARBODY.B0103 || 0) + B0103 / 12, 0)
    DECLARBODY.B0102 = DECLARBODY.B0101 - DECLARBODY.B0103

    DECLARBODY.B0105 = accrualService.round((DECLARBODY.B0105 || 0) + B0105 / 12, 0)
    DECLARBODY.B0104 = accrualService.round((DECLARBODY.B0104 || 0) + B0104 / 12 - DECLARBODY.B0105, 0)
    ...
    DECLARBODY.B0109 = Math.min(DECLARBODY.B0103, accrualService.round((DECLARBODY.B0109 || 0) + B0109 / 12, 0))
    DECLARBODY.B0108 = Math.min(DECLARBODY.B0102, accrualService.round((DECLARBODY.B0108 || 0) + B0108 / 12, 0))
    DECLARBODY.B0113 = Math.min(DECLARBODY.B0103 - DECLARBODY.B0109, accrualService.round((DECLARBODY.B0113 || 0) + B0113 / 12, 0))

    DECLARBODY.B0112 = Math.min(DECLARBODY.B0102 - DECLARBODY.B0108, accrualService.round((DECLARBODY.B0112 || 0) + B0112 / 12, 0))
    ...
    DECLARBODY.B0201 = accrualService.round((DECLARBODY.B0201 || 0) + B0201 / 12, 0)
    DECLARBODY.B0203 = accrualService.round((DECLARBODY.B0203 || 0) + B0203 / 12, 0)
    DECLARBODY.B0202 = DECLARBODY.B0201 - DECLARBODY.B0203
    DECLARBODY.B0205 = accrualService.round((DECLARBODY.B0205 || 0) + B0205 / 12, 0)
    DECLARBODY.B0204 = accrualService.round((DECLARBODY.B0204 || 0) + B0204 / 12, 0) - DECLARBODY.B0205
    ...
    DECLARBODY.B0209 = Math.min(DECLARBODY.B0203, accrualService.round((DECLARBODY.B0209 || 0) + B0209 / 12, 0))
    DECLARBODY.B0208 = Math.min(DECLARBODY.B0202, accrualService.round((DECLARBODY.B0208 || 0) + B0208 / 12, 0))
    DECLARBODY.B0213 = Math.min(DECLARBODY.B0203 - DECLARBODY.B0209, accrualService.round((DECLARBODY.B0213 || 0) + B0213 / 12, 0))
    DECLARBODY.B0212 = Math.min(DECLARBODY.B0202 - DECLARBODY.B0208, accrualService.round((DECLARBODY.B0212 || 0) + B0212 / 12, 0))
  ...
  DECLARBODY.B05 = accrualService.round(DECLARBODY.B04 / DECLARBODY.B0101, 1)
  ...
  if (DECLARBODY.B03 > DECLARBODY.B02) {
    ...
    DECLARBODY.B06 = accrualService.round((coefPenalty || 0) * (DECLARBODY.B03 - DECLARBODY.B02) * DECLARBODY.B05, 1)
  }
}
...
const cellFormats = [
  ...
  {
    names: ['A1020', 'A2010_1', 'A2020_1', 'A2040_1', 'A2050_1', 'B04', 'B05'],
    format: {
      type: 'number',
      nillable: true,
      precision: 1
