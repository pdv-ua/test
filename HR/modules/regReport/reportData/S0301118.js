...
const allBodyAttrNames = [
  ...
  'AREACODE_KATOTTG', 'AREACODE_KOATYY', 'KATOTTG', 'KATOTTG_FACT', 'TER_GROM1', 'TER_GROM2', 'CODE_ECONOMICTYPE', 'REASON', 'ZERO_ZVIT',
  'A4080', 'A4090', 'A4100',
...
function prepareStructureReport (data) {
  ...
  data.DECLAR['$'] = {
    ...
    'xsi:noNamespaceSchemaLocation': 'S0301118.xsd'
  }
  ...
  `, {
    ...
    periodMonths.forEach(periodMonth => {
      const empPosDatas = UB.Repository('hr_employeePositionS')
        ...
        .where('[dateTo]', '>=', periodMonth.dateFrom)
        .where('[employeeNumberID.mi_deleteDate]', '>=', '#maxdate')
        .where('[employeeID.mi_deleteDate]', '>=', '#maxdate')
        .orderBy('dateFrom')
...
const cellFormats = [
  ...
  },
  {
    names: ['REP_NYEAR', 'A3020_1', 'A3020_2', 'A3040_1', 'A3040_2', 'A3050_1', 'A3050_2', 'A3060_1', 'A3060_2', 'A3070_1', 'A3070_2', 'A3080_1', 'A3080_2', 'A3090_2', 'A4080', 'A4090', 'A4100',
      ...
      'ZERO_ZVIT', 'AREACODE_KATOTTG', 'AREACODE_KOATYY', 'KATOTTG', 'KATOTTG_FACT', 'B4080', 'B4090', 'B4100', 'C7010', 'NOMER', 'CODE_ECONOMICTYPE', 'A3100_1', 'A3100_2', 'A6110', 'A6120', 'A9070'],
    format: {
      type: 'number',
      nillable: true,
      precision: 0
