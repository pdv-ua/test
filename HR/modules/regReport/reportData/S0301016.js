...
function prepareDataSpecific ({ data, params }) {
  ...
  const orgAddress = UB.Repository('ac_address')
    .attrs([
      'addressType', 'address', 'nameTerGrom',
  ...
  DECLARBODY.ADDR_J_POST_INDEX = orgAddress2['postIndex']
  DECLARBODY.ADDR_J_REGION = orgAddress2['regionID.name']
  DECLARBODY.ADDR_J_DISTRICT = orgAddress2['districtID.name']
  DECLARBODY.ADDR_J_TER_GROM = orgAddress2['nameTerGrom']
  DECLARBODY.ADDR_J_CITY = orgAddress2['cityID.name']
  DECLARBODY.ADDR_J_CITY_DISTRICT = orgAddress2['cityDistrictID.name']
  // 'streetType', 
  DECLARBODY.ADDR_J_STEET = orgAddress2['street']
  DECLARBODY.ADDR_J_HOUSE = orgAddress2['house']
  DECLARBODY.ADDR_J_SECTION = orgAddress2['section']
  DECLARBODY.ADDR_J_APARTMENT = orgAddress2['apartment']

  DECLARBODY.ADDR_F_POST_INDEX = orgAddress1['postIndex'] || orgAddress2['postIndex'] || ''
  DECLARBODY.ADDR_F_REGION = orgAddress1['regionID.name'] || orgAddress2['regionID.name'] || ''
  DECLARBODY.ADDR_F_DISTRICT = orgAddress1['districtID.name'] || orgAddress2['districtID.name'] || ''
  DECLARBODY.ADDR_F_TER_GROM = orgAddress1['nameTerGrom'] || orgAddress2['nameTerGrom'] || ''
  DECLARBODY.ADDR_F_CITY = orgAddress1['cityID.name'] || orgAddress2['cityID.name'] || ''
  DECLARBODY.ADDR_F_CITY_DISTRICT = orgAddress1['cityDistrictID.name'] || orgAddress2['cityDistrictID.name'] || ''
  // 'streetType', 
  DECLARBODY.ADDR_F_STEET = orgAddress1['street'] || orgAddress2['street'] || ''
  DECLARBODY.ADDR_F_HOUSE = orgAddress1['house'] || orgAddress2['house'] || ''
  DECLARBODY.ADDR_F_SECTION = orgAddress1['section'] || orgAddress2['section'] || ''
  DECLARBODY.ADDR_F_APARTMENT = orgAddress1['apartment'] || orgAddress2['apartment'] || ''
