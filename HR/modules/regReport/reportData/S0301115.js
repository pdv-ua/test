...
function prepareStructureReport (data) {
  ...
  data.DECLAR['$'] = {
    ...
    'xsi:noNamespaceSchemaLocation': 'S0301115.xsd'
  }
...
function prepareDataSpecific ({ data, params }) {
  ...
  DECLARBODY.N1 = DECLARBODY.HKVED
  ...
  if (data.DECLAR.DECLARHEAD.PERIOD_MONTH === 12) {
    ...
    DECLARBODY.A3090_1 = timeSheets3090.c_all || 0
    DECLARBODY.A3090_2 = timeSheets3090.c_women || 0
    ...
    DECLARBODY.A3100_1 = timeSheets3100.c_all || 0
    DECLARBODY.A3100_2 = timeSheets3100.c_women || 0
  }
  ...
  periodMonths.forEach(periodMonth => {
    const empPosDatas = UB.Repository('hr_employeePositionS')
      ...
      .attrs(['employeeNumberID', 'workPlace', 'workScheduleID', 'employeeNumberID.dateFrom', 'employeeNumberID.dateTo',
        'employeeNumberID.employeeID.sexType', 'dictFundSourceID', 'dictStaffCatID.accCategory'])
      .selectAsObject({
  ...
  const workedTimeData = UB.Repository('tim_timeSheet')
    .where('[employeeNumberID]', 'in', periodMonths[2].empNumIDs)
    .where('[isActive]', '=', true)
...
const cellFormats = [
  ...
  },
  {
    names: ['REP_NYEAR', 'A3020_1', 'A3020_2', 'A3040_1', 'A3040_2', 'A3050_1', 'A3050_2', 'A3060_1', 'A3060_2', 'A3070_1', 'A3070_2', 'A3080_1', 'A3080_2', 'A3090_2', 'A4080', 'A4090', 'A4100',
      ...
      'B4080', 'B4090', 'B4100', 'C7010', 'NOMER', 'A3100_1', 'A3100_2', 'A6110', 'A6120'],
    format: {
      type: 'number',
      nillable: true,
      precision: 0
  ...
  {
    names: ['A5030', 'A5040', 'A5050', 'A5060', 'A5070', 'A5080', 'A5090', 'B7010', 'B7020', 'B7030', 'B7040', 'A5051', 'A5052', 'A5010', 'A5020'],
    format: {
      type: 'number',
      nillable: true,
      precision: 1
