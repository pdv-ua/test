...
const allBodyAttrNames = [
  'FIRM_ADR', 'FIRM_ADR_FIZ', 'FIRM_EDRPOU', 'FIRM_NAME', 'FIRM_SPATO', 'REP_NYEAR', 'REP_PERNM', 'FIRM_KVED',
  'A1020', 'A1030', 'A1040', 'A1060', 'A1070', 'NOMER', 'N_1', 'N_2', 'N_3', 'OBL', 'RAY',
  'REP_PER1', 'S1_1', 'TER_STRUK', 'SPATO', 'KVED', 'N1', 'N2', 'VIK_RUK', 'VIK_TEL', 'VIK_EMAIL', 'KVED1', 'ZERO_ZVIT', 'REASON'
]
...
function prepareDataSpecific ({ data, params }) {
  ...
  DECLARBODY.N_3 = orgAddress.address || DECLARBODY.FIRM_ADR
  ...
  organiozations.forEach(orgID => {
    ...
    const empCount = reportService.getEmpCount(orgID, empNumIds, period.dateFrom, period.dateTo, reportParams.notAvgQuantityIDs, ['1', '2', '3'])
