...
const allBodyAttrNames = [
  ...
  'REASON1', 'REASON2', 'REASON3', 'REASON4', 'REASON5', 'REASON6', 'KATOTTG', 'KATOTTG_FACT'
]
...
const cellFormats = [
  {
    names: ['FIRM_ADR', 'FIRM_ADR_FIZ', 'FIRM_EDRPOU', 'FIRM_NAME', 'FIRM_SPATO', 'REP_PERNM', 'FIRM_KVED',
      ...
      'RUK', 'VIK_TEL', 'VIK_EMAIL', 'KVED1', 'REASON', 'TER_GROM1', 'TER_GROM2', 'TER_STRUK', 'KATOTTG', 'KATOTTG_FACT'],
    format: {
      type: 'string',
      nillable: true
    }
  ...
  {
    names: ['REP_NYEAR', 'A1040', 'A1060', 'NOMER', 'ZERO_ZVI', 'REASON1', 'REASON2', 'REASON3', 'REASON4',
      'REASON5', 'REASON6'],
    format: {
      type: 'number',
      nillable: true,
