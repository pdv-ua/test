...
const allBodyAttrNames = [
  ...
  'R08G3', 'R091G3', 'R092G3', 'R093G3', 'R094G3', 'R095G3', 'R0105G3', 'R0108G3', 'R0207G3', 'R02011G3', 'R02014G3', 'R02016G3',
...
const cellFormats = [
  ...
  },
  {
    names: ['HFIL', 'R061G3', 'R061G4', 'R062G3', 'R062G4', 'R063G3', 'R063G4',
      'R064G3', 'R064G4', 'R065G3', 'R065G4', 'R066G3', 'R066G4', 'R091G3', 'R092G3', 'R093G3', 'R094G3', 'R095G3']
...
function prepareStructureReport (data) {
  ...
  data.DECLAR['$'] = {
    ...
    'xsi:noNamespaceSchemaLocation': 'J0500109.xsd'
  }
...
function prepareDataSpecific ({ data, params }) {
  ...
  const infoByAcc = UB.Repository('hr_payObligatory')
    ...
    .limit(1)
    .selectSingle() || {}
  const reportParams = reportService.getReportParams(params.organizationID, ['notAvgQuantity', 'ECBVAC', 'ECBR012G3', 'ECBR011G3', 'ECBR013G3', 'ECBR014G3', 'ECBR015G3', 'ECBR016G3', 'ECBR095G3'])
  ...
  if (reportParams && reportParams.ECBR095G3IDs.length) {
    let empCatESB = UB.Repository('hr_employeeNumberS')
      .attrs(['ID'])
      .where('orgID', 'in', organizations)
      .where('dictCategoryECBID', 'in', reportParams.ECBR095G3IDs)
      .selectSingle()
    DECLARBODY.R095G3 = empCatESB ? 1 : 0
  } else {
    DECLARBODY.R095G3 = 0
  }
  ...
  periods.forEach((period) => {
    ...
    if (params.contractorID) {
      ...
      const payObligatoryDep = UB.Repository('hr_payObligatoryDep')
        ...
        .where('payObligatoryID.organizationID', 'in', organizations)
    ...
    if (params.FORM_TYPE !== 'HZD') {
      const empCount = reportService.getEmpCount(organizations, employeeNumbers, period.dateFrom, period.dateTo, reportParams.notAvgQuantityIDs, ['1'])
