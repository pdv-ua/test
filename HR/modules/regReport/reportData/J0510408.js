...
function prepareStructureReport () {
  ...
  data.DECLAR['$'] = {
    ...
    'xsi:noNamespaceSchemaLocation': 'J0510408.xsd'
  }
...
function getAllData (params, periodCalc) {
  const organiozations = (params.includeSubOrg && params.isIncludeOrg4)
...
function xmlExport ({ data, idx }) {
  ...
  // del Military data
  if (data.data.repCode !== 'J05104081') {
