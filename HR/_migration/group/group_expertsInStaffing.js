module.exports = [
  {
    code: 'group_expertsInStaffing',
    name: 'Фахівець з ведення штатного розпису',
    name_uk: 'Фахівець з ведення штатного розпису',
    name_ru: 'Специалист по ведению штатного расписания',
    name_az: 'Planlaşdırma üzrə mütəxəssis',
    description: 'Фахівець з ведення штатного розпису',
    groupRole: [
      'acc_user',
