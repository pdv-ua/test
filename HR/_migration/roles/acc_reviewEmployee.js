module.exports = [
  {
    name: 'acc_reviewEmployee',
    description: 'Переглядач Електронної картки Особи',
    description_uk: 'Переглядач Електронної картки Особи',
    description_ru: 'Просмотрщик Электронной карточки Физического Лица',
    description_az: 'Şəxsin elektron kartına baxış',
    sessionTimeout: 30,
