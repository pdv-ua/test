...
module.exports = [{
  name: 'acc_reviewTimeSheetChangeDep',
  description: 'Переглядач індівідуального розкладу роботи працівників підрозділу',
  description_uk: 'Переглядач індівідуального розкладу роботи працівників підрозділу',
  description_ru: 'Просмотрщик индивидуального расписания работы сотрудников подразделения',
  sessionTimeout: 30,
