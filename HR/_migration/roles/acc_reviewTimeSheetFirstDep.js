...
module.exports = [{
  name: 'acc_reviewTimeSheetFirstDep',
  description: 'Переглядач табеля структурного підрозділу',
  description_uk: 'Переглядач табеля структурного підрозділу',
  description_ru: 'Просмотрщик табеля структурного подразделения',
  sessionTimeout: 30,
...
function getMethodSet () {
  let methodSet = ['select', 'viewPrintForm', 'loadData', 'runTableReport', 'canViewFirstDep']
