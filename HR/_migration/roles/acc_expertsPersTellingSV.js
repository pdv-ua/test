module.exports = [
  {
    name: 'acc_expertsPersTellingSV',
    description: 'Фахівець обліку персоналу (супервізор)',
    description_uk: 'Фахівець обліку персоналу (супервізор)',
    description_ru: 'Специалист учета персонала (супервизор)',
    sessionTimeout: 30,
    ...
    elsRule: [
      ...
      },
      {
        ...
        methodMask: ['select', 'canDelete', 'canEditOrders', 'update', 'canEditPos', 'canEditDateTo', 'updateFactPosition']
      },
      {
      ...
      },
      {
        ...
        methodMask: ['select', 'addnew', 'insert', 'update', 'canEditDates', 'getNextTabNum', 'checkParams']
      },
      {
