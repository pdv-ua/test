...
me.entity.addMethod('calcSeverance')
...
me.details = [
  {
    ...
    fieldList: orderService.setFieldListAttribute(['orderID', 'periodID.name', 'dateFrom', 'dateTo',
      'flagsFix', 'opDays', 'opHours', 'baseSum', 'opSum', 'baseSumNotIndex', 'opKoef', 'accrualDt'
  ...
  if (orderRegistryDtID) {
    ...
    store.run('update', {
      ...
      execParams: {
        ...
        orderDateFrom: execParams.dateFrom || previousValues.orderDateFrom,
        orderDateTo: execParams.dateFrom || previousValues.orderDateTo,
        dateFrom: dateFrom,
        dateTo: dateFrom,
        avgCalcType: execParams.avgCalcType,
        calcSum: execParams.avgSumRst,
        baseSum: execParams.avgSumWork,
...
function afterInsert (ctx) {
  ...
  store.run('insert', {
    ...
    execParams: {
      ...
      orderDateTo: execParams.dateFrom,
      avgCalcType: execParams.avgCalcType,
      calcSum: execParams.avgSumRst,
      baseSum: execParams.avgSumWork,
      dateFromAvg: execParams.dateFromAvg,
