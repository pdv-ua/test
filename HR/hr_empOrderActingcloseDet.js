...
me.details = [
  {
    detailName: 'hr_empOrderActingCloseEmp',
    entityName: 'hr_empOrderActingCloseEmp',
    docIDName: 'paraID',
    fieldList: orderService.setFieldListAttribute([
      'itemIdx', 'employeePositionID', 'actingID.employeePositionID.description', 'employeeID', 'dateFrom', 'dateTo', 'empOrderType'
    ], ['lineNum'])
  }
]
...
function beforeUpdate (ctx) {
  ...
  if (ctx.mParams.formData) {
    ...
    formData.detail.hr_empOrderActingCloseEmp.insert.forEach(item => {
