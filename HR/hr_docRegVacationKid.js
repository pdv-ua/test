...
me.details = [
  {
    ...
    fieldList: orderService.setFieldListAttribute([ 'employeeNumberID', 'orderID', 'orderRegistryID', 'orderNumber',
      ...
      'orderDate', 'calendarDays', 'periodSalaryID.dateFrom', 'periodSalaryID.dateTo', 'orderDateFrom', 'orderDateTo',
      'flagsFix', 'mask', 'flagsRec', 'accrualDt'
    ], ['lineNum'])
  }
]
    ...
    orderRegistryDt.forEach(row => {
      ...
      while (date <= dateTo) {
        timeSheetParams.push({
          ...
          entityName: 'hr_docRegVacationKid',
