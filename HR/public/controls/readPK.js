...
Ext.define('HR.controls.ReadPK', {
  ...
  statics: {
     ...
     */
    getPkParam: function () {
      let readPkForm = Ext.create('HR.controls.ReadPK', {})
  ...
  initComponent: function () {
    ...
    me.chkCachePrivateKey = Ext.create('Ext.form.field.Checkbox', {
      margin: '10 40 10 80',
      // cls: 'ub-login-input',
      labelClsExtra: 'fa fa-key fa-2x',
      // requireText: UB.i18n('cachePrivateKey'),
      boxLabel: UB.i18n('cachePrivateKey'),
      cheked: false,
      labelSeparator: '',
      // labelWidth: 40,
      anchor: '100%'
    ...
    UB.Repository('ac_settingsOrg')
      ...
      .where('[constantID.code]', '=', 'cachingPrivateKey')
      .selectScalar()
      .then(A => {
        me.chkCachePrivateKey.setValue(A === '1')
      })
  ...
  submitForm: function () {
    ...
    me.deferred.resolve({
      ...
      cachePrivateKey: me.chkCachePrivateKey.getValue()
    })
...
module.exports = {
  getPkParam: function () {
    return HR.controls.ReadPK.getPkParam()
  }
}
