...
function onFormDataReady () {
  ...
  if (me.isNewInstance) {
    me.setTitle(`${UB.i18n('Неоплачувана відпустка')} ${me.record.get('orderNumber')} (${UB.i18n('Створення')})`)
  } else {
    me.setTitle(`${UB.i18n('Неоплачувана відпустка')} ${me.record.get('orderNumber')}`)
  }
