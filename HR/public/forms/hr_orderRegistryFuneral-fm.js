...
function onFormDataReady () {
  ...
  if (me.isNewInstance) {
    me.setTitle(`${UB.i18n('Допомога на поховання')} ${me.record.get('orderNumber')} (${UB.i18n('Створення')})`)
  } else {
    me.setTitle(`${UB.i18n('Допомога на поховання')} ${me.record.get('orderNumber')}`)
  }
