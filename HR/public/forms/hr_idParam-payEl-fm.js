...
function initComponentDone () {
  ...
  me.attr.payElID = me.queryById('payElID')
}

function initUBComponent () {
  const me = this

  me.attr.payElID.store.ubRequest.whereList = {
    byNotExists: {
      expression: '',
      condition: 'subquery',
  ...
  if (!me.isNewInstance) {
    me.attr.payElID.setValueById(me.record.get('valuesID'))
  }
}
...
function onFormDataReady () {
  ...
  valuesID !== me.attr.payElID.getValue() && me.attr.payElID.setValueById(valuesID || null)
}
