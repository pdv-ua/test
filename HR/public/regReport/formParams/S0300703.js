...
},
{
 ...
 {
    title: UB.i18n('Шкала к-сті працівників'),
    xtype: 'panel',
    layout: 'fit',
    align: 'stretch',
    border: 2,
        ...
        items: [
          {
            ...
            entityConfig: {
              ...
              fieldList: [
                ...
                {
                  name: 'valuesFloat',
                  description: UB.i18n('Розмір підприємства'),
                  editor: {
                    width: 200,
                    maxWidth: 200,
                    enableKeyEvents: true,
                ...
                {
                  name: 'valuesFloat1',
                  description: UB.i18n('Кількість працівників в обстеженні'),
                  editor: {
                    width: 200,
                    maxWidth: 200,
                    enableKeyEvents: true,
              ...
              UB.Repository('hr_reportParam')
                ...
                .then(listParamID => {
                  ...
                  grid.store.ubRequest.whereList.byOrg = {
                    expression: '[orgID]',
                    condition: 'equal',
                    value: this.parentContext.orgID
                  }
                })
            },
