...
module.exports = {
  ...
  setDefaultValues: async (me) => {
    ...
    if (!ctrls.C_REG.getValue() || !ctrls.C_RAJ.getValue() || !ctrls.bosID.getValue() || !ctrls.respID.getValue()) {
  ...
  items: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          formParams: true,
          labelWidth: 300,
          fieldLabel: UB.i18n('Визначати дату звільнення як перший не робочий день')
        }
      ]
    },
    {
