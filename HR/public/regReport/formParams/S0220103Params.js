    ...
    if (!ctrls.C_REG.getValue() || !ctrls.C_RAJ.getValue() || !ctrls.bosID.getValue()) {
      ...
      if (regReportID) {
        ...
        if (contentData && contentData.formParams) {
          ...
          if (!ctrls.minDebtEmp.getValue()) {
            ctrls.minDebtEmp.setValue(contentData.formParams['minDebtEmp'])
          }
        }
      }
    }
  ...
  items: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'minDebtEmp',
          decimalPrecision: 2,
          fieldLabel: UB.i18n(`Мінімальна заборгованість працівника для відображення (грн)`),
          formParams: true,
          hideTrigger: true,
          minValue: 0,
          labelWidth: 300
