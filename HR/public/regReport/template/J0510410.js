    ...
    <body>
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td width="33%"></td>
                <td width="33%">
                    Додаток 4 ДФ до Податкового розрахунку сум доходу, нарахованого<br /> (сплаченого) на користь платників податків - фізичних осіб, і сум<br />  утриманого з них податку, а також сумнарахованого єдиного внеску<br />  (пункт 4 роділу ІV)
                </td>
            </tr>
            <tr>
                <td colspan="3">&nbsp;</td>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td class="aroundBorder subtableHedaer" width="70%" rowspan="3" >
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td class="aroundBorder" width="35%" align="center" rowspan="2"></td>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td class="aroundBorder" width="25%" rowspan="2">Платник</td>
                <td class="aroundBorder" width="70%" align="center">{{#textInput}}DECLAR.DECLARBODY.HNAME####{"style": "font-weight: bold;"}{{{}}}{{/textInput}}</td>
            </tr>
            <tr>
                <td class="aroundBorder" align="center">(повне найменування юридичної особи чи прізвище, ім’я та побатькові (за наявності) самозайнятої фізичної особи)</td>
            </tr>
            <tr>
                <td colspan="3">&nbsp;</td>
            </tr>
        ...
        <tr>
                <td  rowspan="4" width="8%" align="center" class="no-print">08</td>
