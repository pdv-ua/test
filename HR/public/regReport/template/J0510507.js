    ...
    <body>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            <tr>
                ...
                <td class="aroundBorder" width="25%" align="center">{{#intInput}}DECLAR.DECLARBODY.HZY{{{}}}{{/intInput}}</td>
                <td class="aroundBorder" width="25%" align="center">{{#intInput}}DECLAR.DECLARBODY.HZKV{{{}}}{{/intInput}}</td>
                <td class="aroundBorder" width="30%" align="center">{{#intInput}}DECLAR.DECLARBODY.HNUM1{{{}}}{{/intInput}}</td>
            </tr>
            <tr>
                <td class="topBorder aroundBorder" width="25%" align="center">(рік)</td>
                <td class="topBorder aroundBorder" width="25%" align="center">(квартал)</td>
                <td class="topBorder aroundBorder" width="30%" align="center">(номер додатку до Розрахунку)</td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            ...
            <tr>
                ...
                <td class="aroundBorder">Податковий номер ліквідованого платника єдиного внеску (заповнюється у разі подання розрахунку правонаступником при поданні розрахунку з типом «Уточнюючий»<sup>8</sup>)</td>
            ...
            <tr>
                <td class="aroundBorder" width="5%" align="center">035</td>
                <td class="aroundBorder">Код філії (заповнюється у разі подання платником єдиного внеску відомостей про філію при поданні розрахунку з типом «Уточнюючий»<sup>9</sup>)</td>
            ...
            <tr>
                <td class="aroundBorder" width="5%" rowspan="2" align="center">036</td>
                <td class="aroundBorder">для призначення пенсії <sup>10</sup></td>
                <td class="aroundBorder">{{#booleanInput}}DECLAR.DECLARBODY.H01{{{}}}{{/booleanInput}}</td>
            </tr>
            <tr>
                <td class="aroundBorder">для призначення інших соціальних виплат <sup>11</sup></td>
        ...
        <table id="table" style="table-layout: auto; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black;" border="1" cellspacing="0" cellpadding="0px" bordercolor="black" width="1485px">
            ...
            <tr>
                ...
                <td align="center" rowspan="2" width="6%">07 Категорія особи ** </td>
                <td align="center" rowspan="2" width="10%">08 Реєстраційний номер облікової картки платника податків або серія (за наявності) та номер паспорта за формою БКNNХХХХХХ/ПХХХХХХХХХ ЗО *</td>
                <td align="center" colspan="3" rowspan="2" width="18%">09 Прізвище, ім'я, по батькові ЗО</td>
                ...
                <td align="center" rowspan="2" width="2%">20 Ознака<sup>14</sup> (0,1)</td>
            </tr>
            <tr>
          ...
          <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            ...
            <tr>
              <td><sup>1</sup> Якщо Д5 подається в складі Розрахунку з типом «Звітний» (пункт 1 розділу ІІІ Порядку).<br/>
                <sup>2</sup> Якщо Д5 подається в складі Розрахунку з типом «Звітний новий» та містить виключно коригування даних відповідно до передбаченого для цього додатку порядку коригування рядків (абзац п’ятий пункту 6 розділу V Порядку);<br/>
                <sup>3</sup> Якщо Д5 подається в складі Розрахунку з типом «Уточнюючий» та містить виключно коригування даних відповідно до передбаченого для цього додатку порядку коригування рядків (абзац п’ятий пункту 6 розділу V Порядку).<br/>
                <sup>4</sup> Якщо Д5 подається в складі Розрахунку з типом «Звітний» як «Довідковий» з позначкою «призначення пенсії» або «призначення матеріального забезпечення, страхових виплат» призначення пенсії та призначення матеріального забезпечення, страхових виплат.<br/>
                ...
                <sup>10</sup> Зазначається позначка у разі подання Д5 для призначення пенсії застрахованим особам.<br/>
                <sup>11</sup> Зазначається позначка у разі подання Д5 для призначення матеріального забезпечення, страхових виплат.<br/>
                <sup>12</sup> Категорія особи: 1 - наймані працівники (з трудовою книжкою); 2 - наймані працівники (без трудової книжки); 3 - особи, які виконують роботи за договорами цивільно-правового характеру; 4 - особи, яким надано відпустку по догляду за дитиною від трирічного віку до досягнення нею шестирічного віку; 
                ...
                які отримують допомогу у зв’язку з вагітністю та пологами; 8 - особи із числа військовослужбовців, особи рядового і начальницького складу.<br/>
                <sup>13</sup> Для ідентифікації застрахованої особи у Пенсійному фонді України для фізичних осіб, які через свої релігійні переконання відмовляються від прийняття реєстраційного номера облікової картки платника податків та офіційно повідомили про це відповідний контролюючий орган і мають відмітку у паспорті,
                 ...
                 <sup>14</sup> Відображається ознака «0», якщо рядок потрібно ввести, чи ознака «1», якщо рядок потрібно виключити. Графа 20 заповнюється для «Звітного нового» та «Уточнюючого» Розрахунків.
                </td>
            </tr>
          </table>
          <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
