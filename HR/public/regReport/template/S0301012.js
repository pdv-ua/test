...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            ...
            <td align="center" rowspan="2" valign="middle" width="30%"><b>№ 1-ПВ</b><br clear="none">(місячна)<br clear="none">ЗАТВЕРДЖЕНО <br clear="none"> Наказ Держстату <br clear="none"> 17.06.2020 № 179</td>
        </tr>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
    <tr>
    <td align="center" colspan="3" style="padding: 4px;"><b>Заповнюється респондентом в разі подання форми в електронному вигляді<br clear="none">стосовно ознак структурного підрозділу</b></td>
     </tr>
        <tr>
            <td>Код виду економічної діяльності за КВЕД</td>
            <td align="center" class="td_box" width="30%" style="padding: 10px">
                {{#textInput}}DECLAR.DECLARBODY.KVED{{{}}}{{/textInput}}
            </td>
            <td width="40%">&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td>Код території за КОАТУУ</td>
            <td align="center" class="td_box" width="30%" style="padding: 10px">
                {{#textInput}}DECLAR.DECLARBODY.TER_STRUK{{{}}}{{/textInput}}
            </td>
            <td width="40%">&nbsp;&nbsp;</td>
        </tr>
    </tbody>
