...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            ...
            <td align="center" rowspan="2" valign="middle" width="30%"><b>№ 3-борг</b><br clear="none">(місячна)<br clear="none">ЗАТВЕРДЖЕНО <br clear="none"> Наказ Держстату <br clear="none"> 23 червня 2022 р.No 195</td>
        </tr>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
       <tr>
            <td align="center" width="40%" style="padding: 4px;"></td>
             <td align="center" width="50%" style="padding: 4px;"></td>
            <td align="center" width="10%"  style="padding: 4px;"></td>
        </tr>
        <tr>
            <td align="center" colspan="2" style="padding: 4px;"><b>Інформація щодо відсутності даних</b></td>
            <td align="center" width="10%"  style="padding: 4px;"></td>
        </tr>
        <tr>
            <td colspan="2" >У випадку відсутності даних необхідно поставити у прямокутнику позначку - v</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">
            {{#booleanInput}}DECLAR.DECLARBODY.A2000####{"changeValues": { "DECLAR.DECLARBODY.REASON": "epsReason" }}{{{}}}{{/booleanInput}}</td>
        </tr>
        <tr>
            <td colspan="3" style="padding: 4px;">Зазначте причину відсутності даних:</td>
        </tr>
         <tr>
            <td style="padding: 4px; colspan="2""> {{#textInput}}DECLAR.DECLARBODY.REASON####{{{}}}{{/textInput}}</td>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>Обсяги заборгованості з оплати праці на підприємстві (установі, організації)</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">{{#float1Input}}DECLAR.DECLARBODY.A2010_1####{ "detailData":"A2010_1"}{{{}}}{{/float1Input}}</td>
        </tr>
        <tr>
            ...
            <td align="right">{{#float1Input}}DECLAR.DECLARBODY.A2020_1####{ "detailData":"A2020_1"}{{{}}}{{/float1Input}}</td>
        </tr>
        <tr>
            <td>Кількість працівників, яким своєчасно не виплачено заробітну плату, oci6 <i>(у цілих числах)</i></td>
            <td align="center">2030</td>
            <td align="right">{{#intInput}}DECLAR.DECLARBODY.A2030_1####{ "detailData":"A2030_1"}{{{}}}{{/intInput}}</td>
        </tr>
        <tr>
            <td>Сума заборгованості з оплати перших п'яти днів тимчасової непрацездатності за рахунок коштів роботодавця, тис.грн <i>(з одним десятковим знаком)</i></td>
            <td align="center">2040</td>
            <td align="right">{{#float1Input}}DECLAR.DECLARBODY.A2040_1####{"changeValues": {"DECLAR.DECLARBODY.A2010_1": {"0": ""},"DECLAR.DECLARBODY.A2020_1": {"0": ""},"DECLAR.DECLARBODY.A2030_1": {"0": ""},"DECLAR.DECLARBODY.A2050_1": {"0": ""}, "DECLAR.DECLARBODY.A2000": {"0": 1, "1": 0, "cellType": "checkbox"}, "DECLAR.DECLARBODY.N1": {"0": ""}},"detailData":"A2040_1"}{{{}}}{{/float1Input}}</td>
        </tr>
        <tr>
            ...
            <td align="right">{{#float1Input}}DECLAR.DECLARBODY.A2050_1####{ "detailData":"A2050_1"}{{{}}}{{/float1Input}}</td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
