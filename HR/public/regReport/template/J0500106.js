    ...
    <body>
        ...
        <table data-table="013" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td class="joinTables" colspan="2" align="center">{{#textInput}}DECLAR.DECLARBODY.CLASSRISK{{{}}}{{/textInput}}</td>
            </tr>
            <tr>
        ...
        <table data-table="1" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                ...
                <td class="joinTables" width="65%">Штатна чисельність працівників, усього в розрізі місяців звітного кварталу (показники кількості працівників зазначаються в цілих одиницях)</td>
                <td class="joinTables" width="10%" align="center">1</td>
                <td class="joinTables" width="10%" align="center">2</td>
                <td class="joinTables" width="10%" align="center">3</td>
            </tr>
            <tr>
        ...
        <table data-table="7" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                <td class="joinTables" width="8%" align="center">5</td>
                <td class="joinTables" width="50%">Сума пені, яка нарахована платником єдиного внеску самостійно відповідно до частини другої статті 25 Закону України «Про збір та облік єдиного внеску на загальнообов’язкове державне соціальне страхування» що підлягає сплаті за звітний квартал, усього (гр. 1 + гр. 2 + гр. 3 рядка 5.1)</td>
                <td class="joinTables" colspan="3" width="42%" align="center">{{#currencyInput}}DECLAR.DECLARBODY.R0105G3{{{}}}{{/currencyInput}}</td>
        ...
        <table data-table="12" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                <td class="joinTables" width="8%" align="center">7</td>
        ...
        <table data-table="16" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
            <tr>
                <td class="joinTables" width="8%" align="center">11</td>
                <td class="joinTables" width="50%">Сума пені, яка нарахована платником єдиного внеску самостійно відповідно до частини другої статті 25 Закону України «Про збір та облік єдиного внеску на загальнообов’язкове державне соціальне страхування» що підлягає сплаті за звітний квартал, усього (гр. 1 + гр. 2 + гр. 3 рядка 11.1)</td>
