...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        ...
        <tr>
            <td width="12%">&nbsp;</td>
            <td align="center" colspan="3" style="padding: 4px; border: 1px solid black"><b>Статистична конфіденційність забезпечується <br clear="none"> статтею 29 Закону України "Про офіційну <br clear="none"> статистику"</b></td>
            <td width="12%">&nbsp;</td>
        </tr>
        <tr>
            <td colspan="5">&nbsp;</td>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            ...
            <td align="center" rowspan="2" valign="middle" width="30%"><b>№ 1-ПВ</b><br clear="none">(квартальна)<br clear="none">ЗАТВЕРДЖЕНО <br clear="none"> Наказ Держстату <br clear="none"> 30 березня 2023 р.No 128</td>
        </tr>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        ...
        <tr>
            ...
            <td class="td_unln" colspan="2">
                <!--<input class="edtCss" id="N1" lz-maxoccurs="1" lz-minoccurs="0" lz-nillable="true" lz-type="xs:string" style="width:100%;" type="textbox" value="" lz-ref-id="HKVED" lz-ref-link="N1:alias" lz-ref-type="common">-->
                {{#intInput}}DECLAR.DECLARBODY.CODE_ECONOMICTYPE####{"style": "font-weight: bold;"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="font-size:0.75em;"><i>(код виду економічної діяльності визначається автоматично)</i></td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        ...
        <tr>
            ...
            {{#booleanInput}}DECLAR.DECLARBODY.ZERO_ZVI####{"printType":"box", "cleanAbsent": ["DECLAR.DECLARBODY.REASON2","DECLAR.DECLARBODY.REASON3","DECLAR.DECLARBODY.REASON4","DECLAR.DECLARBODY.REASON5","DECLAR.DECLARBODY.REASON6"]}{{{}}}{{/booleanInput}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.REASON2####{"printType":"box", "checkParent": "DECLAR.DECLARBODY.ZERO_ZVI", "linkedPath": ["DECLAR.DECLARBODY.REASON3","DECLAR.DECLARBODY.REASON4","DECLAR.DECLARBODY.REASON5","DECLAR.DECLARBODY.REASON6"]}{{{}}}{{/booleanInput}}</td>
        </tr>
         <tr>
            <td>Здійснюється сезонна діяльність або економічна діяльність, пов'язана з тривалим циклом виробництва</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.REASON3####{"printType":"box", "checkParent": "DECLAR.DECLARBODY.ZERO_ZVI", "linkedPath": ["DECLAR.DECLARBODY.REASON2","DECLAR.DECLARBODY.REASON4","DECLAR.DECLARBODY.REASON5","DECLAR.DECLARBODY.REASON6"]}{{{}}}{{/booleanInput}}</td>
        </tr>
         <tr>
            <td>Тимчасово призупинено економічну діяльність через економічні чинники/карантинні обмеження</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.REASON4####{"printType":"box", "checkParent": "DECLAR.DECLARBODY.ZERO_ZVI", "linkedPath": ["DECLAR.DECLARBODY.REASON2","DECLAR.DECLARBODY.REASON3","DECLAR.DECLARBODY.REASON5","DECLAR.DECLARBODY.REASON6"]}{{{}}}{{/booleanInput}}</td>
        </tr>
         <tr>
            <td>Проведено чи проводиться реорганізація або передано виробничі фактори іншій одиниці</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.REASON5####{"printType":"box", "checkParent": "DECLAR.DECLARBODY.ZERO_ZVI", "linkedPath": ["DECLAR.DECLARBODY.REASON2","DECLAR.DECLARBODY.REASON3","DECLAR.DECLARBODY.REASON4","DECLAR.DECLARBODY.REASON6"]}{{{}}}{{/booleanInput}}</td>
        </tr>
         <tr>
            <td>Відсутнє явище, яке спостерігається</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.REASON6####{"printType":"box", "checkParent": "DECLAR.DECLARBODY.ZERO_ZVI", "linkedPath": ["DECLAR.DECLARBODY.REASON2","DECLAR.DECLARBODY.REASON3","DECLAR.DECLARBODY.REASON4","DECLAR.DECLARBODY.REASON5"]}{{{}}}{{/booleanInput}}</td>
        </tr> 
    </tbody>
</table>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>I. Кількість штатних працівників</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3020_1####{"detailData":"A3020_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3020_2####{"detailData":"A3020_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3040_1####{"detailData":"A3040_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3040_2####{"detailData":"A3040_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3050_1####{"detailData":"A3050_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3050_2####{"detailData":"A3050_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3060_1####{"detailData":"A3060_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3060_2####{"detailData":"A3060_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3070_1####{"detailData":"A3070_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3070_2####{"detailData":"A3070_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3080_1####{"detailData":"A3080_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3080_2####{"detailData":"A3080_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3090_2####{"detailData":"A3090_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3100_1####{"detailData":"A3100_1"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A3100_2####{"detailData":"A3100_2"}{{{}}}{{/intInput}}
            </td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>II. Витрати робочого часу штатних працівників</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A4080####{"detailData":"A4080"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.B4080####{"detailData":"B4080"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A4090####{"detailData":"A4090"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.B4090####{"detailData":"B4090"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A4100####{"detailData":"A4100"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.B4100####{"detailData":"B4100"}{{{}}}{{/intInput}}
            </td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>III. Склад фонду оплати праці штатних працівників</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5020####{"detailData":"A5020"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5030####{"detailData":"A5030"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5040####{"detailData":"A5040"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5050####{"detailData":"A5050"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5051####{"detailData":"A5051"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5052####{"detailData":"A5052"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5060####{"detailData":"A5060"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5070####{"detailData":"A5070"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5080####{"detailData":"A5080"}{{{}}}{{/float1Input}}
            </td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.A5090####{"detailData":"A5090"}{{{}}}{{/float1Input}}
            </td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>IV. Кількість і фонд оплати праці окремих категорій працівників</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A7010####{"detailData":"A7010"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.B7010####{"detailData":"B7010"}{{{}}}{{/float1Input}}
            </td>
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.C7010####{"detailData":"C7010"}{{{}}}{{/intInput}}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A7030####{"detailData":"A7030"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.B7030####{"detailData":"B7030"}{{{}}}{{/float1Input}}
            </td>
            <td align="center">x</td>
        </tr>
        <tr>
            ...
            <td align="right">
                {{#intInput}}DECLAR.DECLARBODY.A7040####{"detailData":"A7040"}{{{}}}{{/intInput}}
            </td>
            <td align="right">
                {{#float1Input}}DECLAR.DECLARBODY.B7040####{"detailData":"B7040"}{{{}}}{{/float1Input}}
            </td>
            <td align="center">x</td>
        </tr>
    </tbody>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><b>V. Інформація про укладання колективних договорів станом на 31 грудня</b></td>
        </tr>
        <tr>
            <td align="center" colspan="5"><b>звітного року </b><i>(раз на рік у звіті за IV квартал)</i> </td>
        </tr>
