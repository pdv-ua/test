...
<tr>
    <td class="aroundBorder" width="5%" align="center" rowspan="3">01</td>
    <td class="aroundBorder subtableHedaer"  width="70%" align="center" rowspan="3">
    ...
    <td class="aroundBorder" width="5%" >
        {{#booleanInput}}DECLAR.DECLARBODY.HZ####{"linkedPath": ["DECLAR.DECLARBODY.HZN","DECLAR.DECLARBODY.HZU","DECLAR.DECLARBODY.HZD"]}{{{}}}{{/booleanInput}}
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td class="aroundBorder" width="5%" align="center" rowspan="2"></td>
    <td class="aroundBorder" width="15%" align="center">{{#intInput}}DECLAR.DECLARBODY.PERIOD_MONTH{{{}}}{{/intInput}}</td>
    <td class="aroundBorder" width="50%" align="center" rowspan="2">&nbsp;</td>
</tr>
<tr>
    <td class="topBorder aroundBorder" width="10%" align="center">(рік)</td>
    <td class="topBorder aroundBorder" width="15%" align="center">(місяць)</td>
</tr>
<tr>
    <td colspan="6">&nbsp;</td>
</tr>
...
<table style="table-layout: auto; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            ...
            <tr>
                ...
                <td align="center" width="9%">{{#dateInput}}DECLAR.DECLARBODY.HDDGV####{"style": "font-weight: bold;"}{{{}}}{{/dateInput}}</td>
                <td align="center" width="2%">№</td>
                <td align="center" width="9%">{{#textInput}}DECLAR.DECLARBODY.HNDGV####{"style": "text-align: left; font-weight: bold;"}{{{}}}{{/textInput}}</td>
                <td align="center" width="10%"></td>
                <td class="borderRight" align="right" width="20%"></td>
            </tr>
            <tr>
                <td class="aroundBorder" width="80%" align="center" colspan="7">(повне найменування (прізвище, ім’я, по батькові (за наявності) платника згідно з реєстраційними документами, дата та номер договору (угоди))</td>
            </tr>
...
<tr>
    ...
    <td class="aroundBorder ">
        Податковий номер ліквідованого платника єдиного внеску (заповнюється у разі подання розрахунку правонаступником при поданні розрахунку з типом «Уточнюючий»<sup>7</sup>)
    </td>
...
<tr>
    ...
    <td class="aroundBorder ">
        Код філії (заповнюється у разі подання платником єдиного внеску відомостей про філію при поданні розрахунку з типом «Уточнюючий»<sup>8</sup>)
    </td>
...
<table id="table" style="table-layout: auto; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black;" border="1" cellspacing="0" cellpadding="0px" bordercolor="black" width="1485px">
  <thead>
    <tr>
      ...
      <td align="center" width="10%"> 07. Реєстраційний номер облікової картки платника податків або серія (за наявності) та/або  номер паспорта за формою БКNNХХХХХХ/ПХХХХХХХХХ ЗО<sup>9</sup></td>
      <td align="center" width="4%"> 8. Код катего-<br>рії ЗО<sup>10</sup> </td>
      <td align="center" width="4%"> 09. Код типу нараху-<br>вань<sup>11</sup> </td>
      <td align="center" colspan="2" width="9%"> 10. Місяць та рік, за який проведено нарахування<sup>12</sup> </td>
      ...
      <td align="center" rowspan="2" width="4%">25. Ознака<sup>14</sup> (0,1)</td>
      <td align="center" rowspan="2" width="4%">26. Ознака наявності трудового договору з нефіксованим робочим часом<sup>15</sup> (1-так, 0-ні)</td>
    </tr>
    <tr>
      <td align="center" colspan="5"> 11. Прізвище Iм'я По батькові ЗО  </td>
      <td align="center"> 13. Кількість календарних  днів без збереження заробітної плати<sup>13</sup>  </td>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            ...
            <tr>
              <td><sup>1</sup> Якщо Д1 подається в складі Розрахунку з типом «Звітний» (пункт 1 розділу ІІІ Порядку).<br/>
                <sup>2</sup> Якщо Д1 подається в складі Розрахунку з типом «Звітний новий» та містить виключно коригування даних відповідно до передбаченого для цього додатку порядку коригування рядків (абзац п’ятий пункту 7 розділу V Порядку);<br/>
                <sup>3</sup> Якщо Д1 подається в складі Розрахунку з типом «Уточнюючий» та містить виключно коригування даних відповідно до передбаченого для цього додатку порядку коригування рядків (абзац п’ятий пункту 7 розділу V Порядку).<br/>
                ...
                <sup>5</sup> Зазначається код за ЄДРПОУ платника єдиного внеску або реєстраційний (обліковий) номер платника податків, який присвоюється контролюючими органами, або реєстраційний номер облікової картки платника податків - фізичної особи.<br/>
                ...
                <sup>7</sup> Зазначається код за ЄДРПОУ ліквідованого платника єдиного внеску у разі подання правонаступником Розрахунку з типом «Уточнюючий» за осіб, що перебували в трудових відносинах чи відносинах цивільно-правового характеру з платником, який ліквідований.<br/>
                ...
                <sup>9</sup> Для ідентифікації застрахованої особи у Пенсійному фонді України для фізичних осіб, які через свої релігійні переконання відмовляються від прийняття реєстраційного номера облікової картки платника податків та офіційно повідомили про це відповідний контролюючий орган і мають відмітку у паспорті,
                 ...
                 <sup>10</sup> Код категорії ЗО - обирається з таблиці відповідності кодів категорії застрахованої особи та кодів бази нарахування і розмірів ставок єдиного внеску на загальнообов’язкове державне соціальне страхування (додаток 1 до Порядку).<br/>
                 ...
                 <sup>12</sup> Місяць та рік, за який проведено нарахування,- реквізит обов’язково повинен бути заповнений.<br/>
                 <sup>13</sup> Кількість календарних днів без збереження заробітної плати - кількість календарних днів.<br/>
                 <sup>14</sup> Відображається ознака «0», якщо рядок потрібно ввести, чи ознака «1», якщо рядок потрібно виключити. Графа 25 заповнюється тільки для «Звітного нового» (при коригуванні сум єдиного внеску та реквізитів) та «Уточнюючого» (виключно при коригуванні реквізитів) цього Додатку.<br/>
                 </td>
            </tr>
          </table>
          <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
