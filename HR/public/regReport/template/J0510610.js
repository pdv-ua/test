    ...
    <td colspan="5">&nbsp;</td>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
           <tr>
                ...
                <td class="aroundBorder" width="25%" rowspan="2">Платник єдиного внеску</td>
                <td class="aroundBorder" width="70%" align="center">{{#textInput}}DECLAR.DECLARBODY.HNAME####{{{}}}{{/textInput}}</td>
            </tr>
            <tr>
                <td class="aroundBorder" align="center">(повне найменування юридичної особи чи прізвище, ім’я та побатькові самозайнятої фізичної особи)</td>
            </tr>
            <tr>
                <td colspan="3">&nbsp;</td>
            </tr>
        ...
        <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            <tr>
                ...
                <td class="aroundBorder" width="25%" align="center">{{#textInput}}DECLAR.DECLARBODY.HTIN####{{{}}}{{/textInput}}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="aroundBorder">{{#textInput}}DECLAR.DECLARBODY.HTIN1####{{{}}}{{/textInput}}</td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
        ...
        <table id="table" style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black;" border="1" cellspacing="0" cellpadding="0px" bordercolor="black" width="1485px">
            <thead>
              <tr>
                ...
                <td align="center" colspan="3" width="18%">06. Реєстраційний номер облікової картки платника податків або серія (за наявності) та/або номер паспорта за формою БКNNХХХХХХ / ПХХХХХХХХХ застрахованої особи<sup>8</sup></td>
                ...
                <td align="center" rowspan="2" width="5%">17. Ознака<sup>9</sup> (0,1)</td>
              </tr>
              <tr>
          ...
          <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
            ...
            <tr>
              <td><sup>1</sup> Якщо Д6 подається в складі Розрахунку з типом «Звітний» (пункт 1 розділу ІІІ Порядку).<br/>
                ...
                <sup>5</sup> Зазначається код згідного з ЄДРПОУ платника єдиного внеску або реєстраційний (обліковий) номер платника податків, який присвоюється контролюючими органами, або реєстраційний номер облікової картки платника податків - фізичної особи.<br/>
                ...
                <sup>7</sup> Зазначається код згідно з ЄДРПОУ ліквідованого платника єдиного внеску у разі подання правонаступником Розрахунку з типом «Уточнюючий» за осіб, що перебували в трудових відносинах чи відносинах цивільно-правового характеру з платником податків, який ліквідований.<br/>
                <sup>8</sup>  Для ідентифікації застрахованої особи у Пенсійному фонді України для фізичних осіб, які через свої релігійні переконання відмовляються від прийняття реєстраційного номера облікової картки платника податків та офіційно повідомили про це відповідний контролюючий орган і мають відмітку у паспорті, зазначаються: для власників паспорта громадянина України зразка 1994 року серія та номер паспорта у форматі БКNNXXXXXX, де БК - константа, що вказує на реєстрацію в Пенсійному фонді України за паспортними даними; NN - дві українські літери серії паспорта (верхній регістр); XXXXXX - шість цифр номера паспорта (з ведучими нулями) або для власників паспорта у формі пластикової картки у форматі ПХХХХХХХХХ, де П - константа, що вказує на реєстрацію в Пенсійному фонді України за паспортними даними; ХХХХХХХХХ - дев’ять цифр номера паспорта громадянина України у формі пластикової картки типу ID-1, що містить безконтактний електронний носій.<br/>
                <sup>9</sup> Відображається ознака «0», якщо рядок потрібно ввести, чи ознака «1», якщо рядок потрібно виключити. Графа 17 заповнюється тільки для Розрахунків «Звітний новий» (при коригуванні сум єдиного внеску та реквізитів) та «Уточнюючий» (при коригуванні виключно реквізитів).<br/>
                </td>
            </tr>
          </table>
          <table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1485px">
