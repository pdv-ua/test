...
<table style="table-layout: auto; margin-left: 15px; font-family: TimesNewRoman; font-size: 12px; border-collapse: collapse;" cellspacing="0" cellpadding="0" width="1050px">
    <tbody>
        <tr>
            <td width="75%" style="font-weight: bold">{{#textSpanReadOnly}}DECLAR.DECLARHEAD.NOTFULLYEAR####{"style": "font-weight: bold;color: red;text-align: left;"}{{{}}}{{/textSpanReadOnly}}</td>
            <td>ЗАТВЕРДЖЕНО</td>
        </tr>
        <tr>
            <td width="55%">&nbsp;</td>
...
<table style="table-layout: auto;text-align: center; margin-left: 15px; border: 1px solid black;font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
   <tbody >
        ...
        <tr style="font-weight: bold; ">
            ...
            <td style="border: 1px solid black;" rowspan="3"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">Код рядка</span></td>
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} rowspan="3"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">Фактично за рік</span></td>
            <td style="border: 1px solid black;" colspan="2">З них</td>
            <td style="border: 1px solid black;" colspan="4">Фактично проживають</td>
            <td style="border: 1px solid black;" colspan="6">За віком (повних років)</td>
        </tr>
        <tr style=" font-weight: bold; ">
            <td style="border: 1px solid black;" rowspan="2"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">чоловіки</span></td>
            <td style="border: 1px solid black;" rowspan="2"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">жінки</span></td>
        ...
        <tr style=" font-weight: bold; ">
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">чоловіки</span></td>
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">жінки</span></td>
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">чоловіки</span></td>
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">жінки</span></td>
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">чоловіки</span></td>
            <td style="border: 1px solid black;"><span style=" writing-mode: vertical-rl; transform: rotate(-180deg); text-align: center; justify-content: center; align-items: center;">жінки</span></td>
       ...
       <tr style="font-weight: bold;">
            ...
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}}>1</td>
            <td style="border: 1px solid black;" >2</td>
            <td style="border: 1px solid black;" >3</td>
            <td style="border: 1px solid black;" >4</td>
            <td style="border: 1px solid black;" >5</td>
        ...
        <tr>
            ...
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#intInput}}DECLAR.DECLARBODY.B0101{{{}}}{{/intInput}}</td>
        ...
        <tr >
            ...
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#intInput}}DECLAR.DECLARBODY.B0201{{{}}}{{/intInput}}</td>
        ...
        <tr >
            ...
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#intInput}}DECLAR.DECLARBODY.B03{{{}}}{{/intInput}}</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
        ...
        <tr >
            ...
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#float1Input}}DECLAR.DECLARBODY.B04{{{}}}{{/float1Input}}</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
        ...
        <tr >
            <td style="border: 1px solid black;" >Середньорічна заробітна плата штатного працівника, грн</td>
            <td style="border: 1px solid black;" >05</td>
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#currencyInput}}DECLAR.DECLARBODY.B05{{{}}}{{/currencyInput}}</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
        ...
        <tr >
            <td style="border: 1px solid black;" >Сума коштів адміністративно-господарських санкцій за невиконання нормативу робочих місць для працевлаштування осіб з інвалідністю, грн</td>
            <td style="border: 1px solid black;" >06</td>
            <td style="border: 1px solid black;" {{#DECLAR.DECLARBODY.widthMaxB}}width="{{DECLAR.DECLARBODY.widthMaxB}}px"{{/DECLAR.DECLARBODY.widthMaxB}} >{{#currencyInput}}DECLAR.DECLARBODY.B06{{{}}}{{/currencyInput}}</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
            <td style="border: 1px solid black;" >x</td>
...
<table style="table-layout: auto; margin-left: 15px; font-family: TimesNewRoman; font-size: 12px; border-collapse: collapse;" cellspacing="0" cellpadding="0" width="1050px">
    <tbody>
        ...
        <tr>
            <td>&nbsp;</td>
            <td style="text-align: center; font-size: 10px; border-top: 1px solid black">(підпис керівника (власника))</td>
            <td>&nbsp;</td>
