...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            ...
            <td align="center" rowspan="2" valign="middle" width="30%"><b>№ 1-ПВ</b><br clear="none">(квартальна)<br clear="none">ЗАТВЕРДЖЕНО <br clear="none"> Наказ Держстату <br clear="none"> 25 червня 2021 р. № 135</td>
        </tr>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td nowrap="nowrap" width="45%"><b>Код території відповідно до:</b></td>
            <td valign="bottom" width="10%">&nbsp;&nbsp;</td>
            <td valign="bottom" width="45%">&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td>Класифікатора адміністративно-територіальних одиниць та територій територіальних громад (КАТОТТГ)</td>
            <td>&nbsp;</td>
            <td>Класифікатора об'єктів адміністративно-територіального устрою України (КОАТУУ)</td>
        </tr>
        <tr>
            <td class="td_unln">
            ...
            <td style="text-align: center;">або</td>
            <td class="td_unln">
                <!--<input class="edtCss" id="N9" lz-maxoccurs="1" lz-minoccurs="0" lz-nillable="true" lz-type="xs:string" style="width:100%;" type="textbox" value="">-->
                {{#textInput}}DECLAR.DECLARBODY.AREACODE_KOATYY####{"style": "font-weight: bold;"}{{{}}}{{/textInput}}
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="font-size:0.75em;"><i>(код території визначається автоматично в разі подання форми в електронному вигляді)</i></td>
        </tr>
    </tbody>
</table>
<br clear="none">
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse; border: 1px solid black" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="2" style="border-text: 1px;">&nbsp;</td>
        </tr>
        <tr>
            <td align="center" colspan="2" style="padding: 4px;"><b>Інформація щодо відсутності даних</b></td>
        </tr>
        <tr>
            <td>У випадку відсутності даних необхідно поставити у прямокутнику позначку - V</td>
            <td align="center" class="td_box" width="10%" style="padding: 10px"">{{#booleanInput}}DECLAR.DECLARBODY.ZERO_ZVIT{{{}}}{{/booleanInput}}</td>
        </tr>
        <tr>
...
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px">
    <tbody>
        <tr>
            <td align="center" colspan="5"><h3>Розділ VI. Витрати на утримання робочої сили, що не входять до складу фонду оплати праці за {{{DECLAR.DECLARBODY.REP_PYEAR}}} р. (у звіті за I квартал)</h3></td>
        </tr>
    </tbody>
</table>
<table style="table-layout: fixed; margin-left: 15px; font-family: TimesNewRoman; border-collapse: collapse;" cellspacing="0" cellpadding="0px" width="1050px" border="1" bordercolor="black" cellspacing="0">
