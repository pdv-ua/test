    ...
    return Promise.all([
      UB.Repository('hr_docRegBountyHelp')
        .attrs(['ID', 'orderNumber', 'orderDate', 'countMonth', 'avgSumMonth', 'dateFrom',
          'employeePositionID', 'employeeID.fullFIO', 'employeeNumberID.tabNum', 'employeeNumberID', 'dateFromAvg', 'dateToAvg', 'employeePositionID.positionID.name', 'employeePositionID.dictPositionID.name', 'employeePositionID.departmentID', 'employeePositionID.organizationID'])
