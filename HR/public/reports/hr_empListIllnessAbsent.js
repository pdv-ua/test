...
exports.reportCode = {
  ...
  getData (reportParams) {
    ...
    const fieldList = ['tabNum', 'fullFIO', 'posName', 'illnessReason', 'dayCount', 'lastName', 'firstName',
      'workPlace', 'orgName', 'serie', 'orderDate', 'selfStructDepName']
  ...
  getParams: function (data) {
    ...
    const params = {
      ...
      colSpan: 11 + (data.showAddDescrPerson ? 1 : 0) + (data.useActualPositionName ? 1 : 0),
      colSpan2: 10 + (data.showAddDescrPerson ? 1 : 0) + (data.useActualPositionName ? 1 : 0),
      tableWidth: 1420 + (data.showAddDescrPerson ? 200 : 0) + (data.useActualPositionName ? 150 : 0),
      personTable: [],
