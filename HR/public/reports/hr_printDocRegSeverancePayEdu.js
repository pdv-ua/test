    ...
    return Promise.all([
      UB.Repository('hr_docRegSeverancePay')
        .attrs(['ID', 'orderNumber', 'orderDate', 'countMonth', 'avgSumWork', 'dateFrom',
          'employeePositionID', 'employeeID.fullFIO', 'employeeNumberID.tabNum', 'employeePositionID.positionID.name', 'employeePositionID.dictPositionID.name', 'employeePositionID.departmentID', 'employeePositionID.organizationID'])
